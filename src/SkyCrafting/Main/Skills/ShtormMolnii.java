...
public class ShtormMolnii implements Listener
{
    private double additionalDamage;
    static WeakHashMap<Player, Long> cols;
    
    static {
    	ShtormMolnii.cols = new WeakHashMap<Player, Long>();
    }
    
    public ShtormMolnii() {
        this.additionalDamage = 3.0;
    }
    ...
    static boolean check(final Player user, final long tmp) {
        ...
        final Long last = ShtormMolnii.cols.get(user);
        ...
        ShtormMolnii.cols.put(user, time);
        return true;
    }
        ...
        try {
            ...
            if (entityTarget == null || entityTarget.getPassenger() != null || entityTarget instanceof Villager || entityTarget instanceof Item) {
                ...
                if (check(Player, 10000L)) {
                    ...
                    final double health = entityTarget.getHealth() - 7.0;
