...
public class DefPointer extends EntityMonster
{
    Spawner spawner;
    int delay;
    int hp_delay;
    ...
    float accuracy;
    Random rand;
    String NameBoss = "Охранник точки ";
    
    @SuppressWarnings("rawtypes")
	public DefPointer(final Spawner spawner) {
    ...
    public void die() {
        ...
        if (this.killer instanceof EntityPlayer) {
            ...
            p.sendMessage(ChatColor.GREEN + "На ваш счет было зачисленно 60$,5 опыт");
            Bosslistener.HoloDiad((org.bukkit.entity.Entity)this.bukkitEntity, 60, 0, 5);
