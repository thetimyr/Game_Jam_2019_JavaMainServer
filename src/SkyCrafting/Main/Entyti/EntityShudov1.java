...
public class EntityShudov1 extends EntityMonster
{
    Spawner spawner;
    int delay;
    int hp_delay;
	...
	public EntityShudov1(final Spawner spawner) {
    ...
    public void die() {
        ...
        if (this.killer != null) {
            ...
            Bukkit.broadcastMessage((String)ChatColor.translateAlternateColorCodes('&', "&4Зомби-гигант№2 &cбыл повержен, нападающие получают по " + q + "$!"));
        }
        super.die();
    }
}
