...
public class EntityObivan extends EntityMonster
{
    Spawner spawner;
	...
	public EntityObivan(final Spawner spawner) {
        ...
        this.setCustomName(ChatColor.RED + "Оби-ван Кеноби" + (int)this.getHealth() + "❤ ");
    ...
    public void die() {
        ...
        if (this.killer != null) {
            ...
            Bukkit.broadcastMessage((String)ChatColor.translateAlternateColorCodes('&', "&4Оби-ван Кеноби &cбыл повержен, нападающие получают по " + q + "$!"));
        }
        super.die();
    }
}