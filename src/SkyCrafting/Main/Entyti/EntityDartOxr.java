...
public class EntityDartOxr extends EntityMonster
{
    Spawner spawner;
    int delay;
    int hp_delay;
	...
	public EntityDartOxr(final Spawner spawner) {
        ...
        this.setEquipment(1, new ItemStack((Item)Items.IRON_HELMET));
        this.setEquipment(2, new ItemStack((Item)Items.IRON_CHESTPLATE));
        this.setEquipment(3, new ItemStack((Item)Items.IRON_LEGGINGS));
        this.setEquipment(4, new ItemStack((Item)Items.IRON_BOOTS));
        this.setEquipment(0, new ItemStack(Items.GOLDEN_SWORD));
        this.setCustomName(ChatColor.RED + "Охранник Айд-жи " + (int)this.getHealth() + "❤ ");
    ...
    public void die() {
        ...
        if (this.killer instanceof EntityPlayer) {
            ...
            p.sendMessage(ChatColor.GREEN + "На ваш счет было зачисленно 50$, 2 опыта и 2 убийство");
 
            
            Bosslistener.HoloDiad((org.bukkit.entity.Entity)this.bukkitEntity, 50, 2, 2);
        }
        super.die();
    }
}