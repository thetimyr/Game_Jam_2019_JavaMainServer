...
public class Mudak extends EntityMonster
{
    Spawner spawner;
	...
	public Mudak(final Spawner spawner) {
        ...
        this.getAttributeInstance(GenericAttributes.maxHealth).setValue(1250.0);
        ...
        this.setEquipment(0, new net.minecraft.server.v1_8_R3.ItemStack(Items.TNT_MINECART));
        this.setCustomName(ChatColor.translateAlternateColorCodes('&', "&c&lТемная Дама " + (int)this.getHealth() + " ❤"));
	...
	public boolean damageEntity(final DamageSource damagesource, final float f) {
        ...
        this.setCustomName(ChatColor.translateAlternateColorCodes('&', "&f&lТемная Дама " + (int)this.getHealth() + " ❤"));
    ...
    public void die() {
        ...
        if (this.killer != null) {
            ...
            drop.add(new ItemStack(Material.RECORD_9));
            drop.add(new ItemStack(Material.ENCHANTED_BOOK));
            ...
            for (final String key : this.attackers.keySet()) {
                ...
                q = money;
                Bukkit.getPlayer(key).sendMessage(ChatColor.GREEN + "На ваш счет было зачисленно " + "20 убийств,50 опыта и " + ChatColor.GREEN + money + "$");
            ...
            Bosslistener.HoloDiad((org.bukkit.entity.Entity)this.bukkitEntity, q, 20, 50);
            Bukkit.broadcastMessage((String)ChatColor.translateAlternateColorCodes('&', "&c&lТемная Дама &cбыл повержен, нападающие получают по " + q + "$!"));
        }
        super.die();
    }
}
