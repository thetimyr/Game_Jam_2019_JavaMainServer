...
public class EntityKailoren extends EntityMonster
{
    Spawner spawner;
	...
	public EntityKailoren(final Spawner spawner) {
        ...
        this.getAttributeInstance(GenericAttributes.FOLLOW_RANGE).setValue(18.0);
        this.getAttributeInstance(GenericAttributes.c).setValue(5.0);
        this.getAttributeInstance(GenericAttributes.MOVEMENT_SPEED).setValue(0.08);
        ...
        final net.minecraft.server.v1_8_R3.ItemStack testSword = CraftItemStack.asNMSCopy(new ItemStack(Material.SAPLING, 1, (short)12));
        ...
        this.setEquipment(0, new net.minecraft.server.v1_8_R3.ItemStack(Items.BONE));
        this.setCustomName(ChatColor.translateAlternateColorCodes('&', "&4&Кайло рен " + (int)this.getHealth() + " ❤"));
	...
	public boolean damageEntity(final DamageSource damagesource, final float f) {
        ...
        this.setCustomName(ChatColor.translateAlternateColorCodes('&', "&4&lКайло Рен " + (int)this.getHealth() + " ❤"));
    ...
    public void die() {
        ...
        if (this.killer != null) {
            ...
            for (final String key : this.attackers.keySet()) {
                ...
                q = money;
                Bukkit.getPlayer(key).sendMessage(ChatColor.GREEN + "На ваш счет было зачисленно " + "20 убийств и 45 опыта и " + ChatColor.GREEN + money + "$");
                Levels.kills.put(this.killer.getName(), Levels.kills.get(this.killer.getName()) + 20);
                Levels.xp.put(this.killer.getName(), Levels.xp.get(this.killer.getName()) + 45);
            ...
            Bosslistener.HoloDiad((org.bukkit.entity.Entity)this.bukkitEntity, q, 20, 45);
            Bukkit.broadcastMessage((String)ChatColor.translateAlternateColorCodes('&', "&4&l&nКайло Рен&4&l! &cбыл повержен, нападающие получают по " + q + "$!"));
        }
        super.die();
    }
}
